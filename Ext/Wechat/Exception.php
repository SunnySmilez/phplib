...
class Exception extends \S\Exception {
    ...
    const UNKNOW_ERROR = -99;

    private static $error = array(
        /**
         * 自定义错误码
         */
        30001 => '获取access_token异常',
        30002 => '获取jsapi_ticket异常',
        /**
         * 以下为腾讯返回错误码
         */
        -100  => 'UNKNOW',
    ...
    public function __construct($message, $code, \Exception $previous = null) {
        if ($code && isset(self::$error[$code])) {
            $message = self::$error[$code];
            $code    = "31{$code}";  //错误码转成31开头
        } else {
            if (!$message) {
                $message = self::$error[self::DEFAULT_ERROR];
            }
        }
