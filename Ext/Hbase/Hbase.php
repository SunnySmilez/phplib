...
//echo "file exists:".class_exists(TProtocol::class); exit;
...
class HbaseClient implements \Hbase\HbaseIf {
  ...
  public function send_getTableNames()
  {
    ...
    //echo "test:".$TBINARYPROTOCOLACCELERATED;exit;
    //echo "test:".function_exists('thrift_protocol_write_binary');exit;
    $a = 'Thrift\Protocol\TBinaryProtocolAccelerated';
    $bin_accel = ($this->output_ instanceof Thrift\Protocol\TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
