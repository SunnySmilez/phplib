...
class Client
{
    ...
    public function __construct(array $config = [], $callback = null)
    {
        ...
        $this->_logger = \S\Log\Logger::getInstance();
     ...
     * logging.
     *
     * @deprecated Overwriting Client->_log is deprecated. Handle logging functionality by using a custom \S\Log\Logger.
     *
     * @param mixed $context
     */
    protected function _log($context)
    {
        if ($context instanceof ConnectionException) {
            $this->_logger->debug(array('Elastica Request Failure', $context,
                $context->getRequest(),
                $this->hasConnection(),
            ));
